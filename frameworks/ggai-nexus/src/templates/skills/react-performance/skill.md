...
description: React and Next.js performance optimization. Use when building React components, optimizing performance, eliminating waterfalls, reducing bundle size, reviewing code for performance issues, or implementing server/client-side optimizations.
allowed-tools: Read, Write, Edit, Glob, Grep, Bash
---

# React Performance Expert

> **Performance Optimization** - 57 optimization rules prioritized by impact
...
| Need                    | Skill                             |
| ----------------------- | --------------------------------- |
| API design patterns     | `react-api-patterns`          |
...
- ✅ Use built-in optimizations (next/image, next/font)
...
1. Identify symptom (slow load, lag, etc.)
...
4. **Use platform features** - Framework has optimizations built-in
